...
import { Loader2, AlertCircle, TrendingUp, BarChart3, Zap, Shield, Mail, Lock, Eye, EyeOff, ChevronRight } from 'lucide-react'
      ...
      <div className="hidden w-1/2 bg-gradient-to-br from-primary via-primary/90 to-primary/80 p-12 lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="space-y-6">
          ...
          <p className="text-lg text-white/80">
            Access your AI-powered trading dashboard and continue making profitable decisions
          </p>
          
          <div className="space-y-4">
            <FeatureItem 
              icon={<BarChart3 className="h-5 w-5" />} 
              text="View your portfolio performance and analytics"
            />
            <FeatureItem 
              icon={<Zap className="h-5 w-5" />} 
              text="Execute trades with AI recommendations"
            />
            <FeatureItem 
              icon={<Shield className="h-5 w-5" />} 
              text="Monitor risk metrics in real-time"
            />
          </div>
        </div>
