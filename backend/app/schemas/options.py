...
class OptionOrderBase(BaseModel):
    """Base option order schema."""
    option_id: UUID
...
class OptionOrderCreate(OptionOrderBase):
    """Option order creation schema."""
    pass


class OptionOrderRequest(OptionOrderBase):
    """Option order request schema."""
    pass


class OptionOrderResponse(OptionOrderBase):
    """Option order response schema."""
    id: UUID
    status: str
...
class OptionStrategyBase(BaseModel):
    """Base option strategy schema."""
    strategy_type: str
    legs: List[OptionStrategyLeg]


class OptionStrategyCreate(OptionStrategyBase):
    """Option strategy creation schema."""
    pass


class OptionStrategyRequest(OptionStrategyBase):
    """Option strategy request."""
    pass


class OptionStrategyResponse(OptionStrategyBase):
    """Option strategy response schema."""
    id: UUID
    portfolio_id: UUID
    status: str
    total_cost: float
